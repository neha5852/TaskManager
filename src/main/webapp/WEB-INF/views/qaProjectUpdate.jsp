...
<button class="btn" onclick="history.back()"><i class="fa fa-home"></i></button>
	...
	-->
			...
			<div class="row">
				...
				<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="qa">Defect in QA</label>
					<div class="col-md-7">
						<form:input type="text" path="qa" id="qa" class="form-control input-sm"  required="required" />
						<div class="has-error">
		   			...
		   			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="uat">Defect in UAT</label>
					<div class="col-md-7">
						<form:input type="text" path="uat" id="uat" class="form-control input-sm"  required="required" />
						<div class="has-error">
							<form:errors path="uat" class="help-inline"/>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="post">Defect in Post Production</label>
					<div class="col-md-7">
						<form:input type="text" path="post" id="post" class="form-control input-sm"  required="required" />
						<div class="has-error">
							<form:errors path="post" class="help-inline"/>
						</div>
					</div>
				</div>
			</div>
